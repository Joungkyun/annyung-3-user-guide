...
_**oops-firewall**_에서 국가 기반의 filtering을 하기 위해서는 [kmod-geoip](../../annyung3-package-catalog/annyung3-core-packages/pkg-core-kmod-geoip.md)가 설치되어 있어야 하고, Netfilter용 GeoIP database를 생성해야 합니다. \(kmod-geoip 설치시에 post script 작업으로 2~3분 정도 설치 중 먹통이 된 것 같은 느낌이 나니, 인내하시기 바랍니다.\)

안녕 리눅스에서는 이 작업을 간편하게 하기 위하여 _**geoip-csv2bin**_ 이라는 실행 명령을 제공합니다.
...
_**geoip-csv2bin**_ 명령을 실행을 하면 다음의 작업을 하게 됩니다.
...
GeoIP database가 준비 되었다면, _**/etc/oops-firewall/user.conf**_ 에서 다음의 rule을 이용하여 관리할 수 있습니다.
